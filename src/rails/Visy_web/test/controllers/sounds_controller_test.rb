...
class SoundsControllerTest < ActionController::TestCase
  ...
  test "should create sound" do
    assert_difference('Sound.count') do
      post :create, sound: { name: @sound.name, playtime: @sound.playtime, sound: @sound.sound, video_id: @sound.video_id }
    end
  ...
  test "should update sound" do
    patch :update, id: @sound, sound: { name: @sound.name, playtime: @sound.playtime, sound: @sound.sound, video_id: @sound.video_id }
    assert_redirected_to sound_path(assigns(:sound))
  end
